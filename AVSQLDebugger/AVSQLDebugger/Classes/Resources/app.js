...
function getData(tableName) {
   ...
   $.ajax({url: "getAllDataFromTheTable/"+tableName, success: function(result){
...
function queryFunction() {
   ...
   $.ajax({url: "query/"+escape(query), success: function(result){
           console.log(result);
           result = JSON.parse(result);
           inflateData(result);
...
function getDBTableList() {
    ...
    $.ajax({url: "getDBTableList", success: function(result){
           ...
           $("#table-list").append("<a href='#table=" + tableName + "' data-table-name='" + tableName
